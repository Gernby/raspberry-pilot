...
serverPathFormatString = "pathPlan,user=" + user_id + " l0=;l1=;l2=;l3=;l4=;l5=;l6=;r0=;r1=;r2=;r3=;r4=;r5=;r6=;c0=;c1=;c2=;c3=;c4=;c5=;c6=;a0=;a1=;a3=;a5=;a7=;a14=;fa0=;fa1=;fa3=;fa5=;fa7=;fa14=;lprob=;rprob=;cprob=;center_comp=;lane_width=;angle=;rate=;angle_offset=;lateral_offset=;actual_angle=;plan_age=; ~"
  ...
  for socket, event in poller.poll(3000):
    ...
    if socket is pathPlan:
      ...
      if not cs is None and not logfile is None:
        ...
        send_data3 = (pp.fastAngles[0][0], pp.fastAngles[0][1], pp.fastAngles[0][2], pp.fastAngles[0][3], pp.fastAngles[0][4], pp.fastAngles[0][6], pp.fastAngles[-1][0], pp.fastAngles[-1][1], pp.fastAngles[-1][2], pp.fastAngles[-1][3], pp.fastAngles[-1][4], pp.fastAngles[-1][6], pp.lProb, pp.rProb, pp.cProb, pp.centerCompensation, pp.laneWidth, pp.angleSteers, pp.rateSteers, pp.angleOffset, pp.lateralOffset, cs.steeringAngle, pp.canTime - pp.canTime, cs.canTime)
