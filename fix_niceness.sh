...
sudo taskset -cp -a --cpu-list 0,1 `ps -C controlsd -o pid= `
sudo taskset -cp -a --cpu-list 0,1 `ps -C boardd -o pid= `
sudo taskset -cp -a --cpu-list 0,1 `ps -C pandad -o pid= `
sudo taskset -cp -a --cpu-list 2,3 `ps -C ubloxd -o pid= `
sudo taskset -cp -a --cpu-list 2,3 `ps -C transcoderd -o pid= `
sudo taskset -cp -a --cpu-list 2,3 `ps -C dashboard -o pid= `
