...
sudo taskset -cp --cpu-list 0,1,2,3 `ps -C controlsd -o pid= `
sudo taskset -cp --cpu-list 0,1,2,3 `ps -C boardd -o pid= `
sudo taskset -cp --cpu-list 0,1 `ps -C ubloxd -o pid= `
#sudo taskset -cp --cpu-list 2,3 `ps -C transcoderd -o pid= `
sudo taskset -cp --cpu-list 2,3 `ps -C dashboard -o pid= `
sudo taskset -cp --cpu-list 0,1 `ps -C influxd -o pid= `
