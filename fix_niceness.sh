...
#sudo renice -n -19 -p `ps -C pandad -o pid= `
...
sudo taskset -cp -a --cpu-list 0,1 `ps -C controlsd -o pid= `  > /dev/null 2>&1
sudo taskset -cp -a --cpu-list 0,1 `ps -C boardd -o pid= `  > /dev/null 2>&1
sudo taskset -cp -a --cpu-list 0,1 `ps -C pandad -o pid= `  > /dev/null 2>&1
sudo taskset -cp -a --cpu-list 2,3 `ps -C ubloxd -o pid= `  > /dev/null 2>&1
sudo taskset -cp -a --cpu-list 2,3 `ps -C transcoderd -o pid= `  > /dev/null 2>&1
sudo taskset -cp -a --cpu-list 2,3 `ps -C dashboard -o pid= `  > /dev/null 2>&1
