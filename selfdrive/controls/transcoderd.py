...
model.predict_on_batch([[model_input[:,:6]], [model_input[:,6:9]], [model_input[-1:,9:11]], [model_input[-1:,11:12]], [model_input[-1:,12:20]], [fingerprint], [model_input[:,20:28]], [model_input[:,-24:-12]], [model_input[:,-12:]]])
frame = 0
