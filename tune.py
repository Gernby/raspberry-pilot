...
param = ["Kp", "Ki", "reactMPC","dampMPC", "reactSteer", "dampSteer", "reactCenter0", "reactCenter1", "reactCenter2", "polyFactor", "polyReact", "polyDamp", "advanceSteer", "angleFactor", "discreteAngle", "wiggleAngle", "deadzone", "modelFactor", "firstModel", "lastModel"]
